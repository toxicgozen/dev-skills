...
If the tickets came from [to-tickets](https://aihero.dev/skills-to-tickets), the tracker they live on was configured by [setup-dev-skills-structure](https://aihero.dev/skills-setup-dev-skills-structure). `code-review` reads the same configuration to find the originating spec at close-out.
