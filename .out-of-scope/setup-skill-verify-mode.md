# Verify/Check Mode for `setup-dev-skills-structure`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-dev-skills-structure`.
...
- #106 — Feature request: verify/check mode for the repo-configuration setup skill
