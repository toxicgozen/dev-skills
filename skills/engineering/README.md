...
- **[domain-modeling](./domain-modeling/SKILL.md)** — Actively build and sharpen a project's ubiquitous language and domain model — challenge terms, stress-test with scenarios, update `CONTEXT.md` and ADRs inline.
