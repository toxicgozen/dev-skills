...
- **[setup-dev-skills-structure](./setup-dev-skills-structure/SKILL.md)** — Configure a consumer repo's issue tracker, triage labels, and domain doc layout. Run once before tracker-dependent flows.
- **[pull-update-dev-skills](./pull-update-dev-skills/SKILL.md)** — Compare this fork with upstream by recorded intent, plan first, then retain, replace, or escalate each overlay.
